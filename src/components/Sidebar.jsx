    ...
    return (
        <>
            ...
            {isSidebarOpen && isMobile && (
                <div
                    className="fixed inset-0 z-40 bg-black/30 backdrop-blur-md bg-opacity-50 lg:hidden"
                    onClick={closeSidebar}
                />
            )}

            <div className={`fixed inset-y-0 z-50 flex flex-col w-72 py-8 bg-white border-r border-gray-200 transition-all duration-300 ease-in-out 
