  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.data?.status === 200) {
        ...
        toast.error(response?.data?.message || "Invalid Credentitals!");
      }
    } catch (error) {
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={`w-full py-3 px-4 text-white font-medium rounded-lg shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center justify-center ${
                  isLoading
