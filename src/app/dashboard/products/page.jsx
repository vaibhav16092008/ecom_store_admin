...
const ProductPage = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        const payload = {
            ...editingProduct,
            discountedPrice: editingProduct.price * (1 - editingProduct.discount / 100)
        };
        ...
        <div className="container mx-auto px-4 py-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            min="0"
                                            step="0.01"
                                            value={editingProduct.price * (1 - editingProduct.discount / 100)}
                                            readOnly
                                        ...
                                        <label className="flex items-center cursor-pointer">
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className="sr-only"
                                                />
                                                <div className={`block w-12 h-6 rounded-full ${editingProduct.isNew ? 'bg-blue-500' : 'bg-gray-300'}`}></div>
                                                <div className={`dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition ${editingProduct.isNew ? 'transform translate-x-6' : ''}`}></div>
                                            </div>
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                                            {editingProduct.images.map((image, index) => (
                                                <div key={index} className="relative group">
                                                    <img src={image} alt={`Product ${index}`} className="h-20 w-full object-cover rounded-md border border-gray-200" />
                                                    <button
                                                        type="button"
            ...
            {isAdding && (
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
                    <div className="p-5">
                        <h2 className="text-lg font-semibold text-gray-800 mb-4">Create New Product</h2>
                                    ...
                                    <label className="flex items-center cursor-pointer">
                                        <div className="relative">
                                            <input
                                                ...
                                                className="sr-only"
                                            />
                                            <div className={`block w-12 h-6 rounded-full ${newProduct.isNew ? 'bg-blue-500' : 'bg-gray-300'}`}></div>
                                            <div className={`dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition ${newProduct.isNew ? 'transform translate-x-6' : ''}`}></div>
                                        </div>
                                        <div className="ml-2 text-sm text-gray-700">
                                            New Product
                                        </div>
                            ...
                            {products.length !== 0 ? (
                                products.map((product) => (
                                    <tr key={product._id || product.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-5 py-4 whitespace-nowrap">
                                            <span className={`px-2 py-1 inline-flex text-xs leading-4 font-semibold rounded-full ${product.isNew ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'}`}>
                                ...
                                <tr>
                                    <td colSpan={5} className='py-4 text-center'>No Products Found</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
