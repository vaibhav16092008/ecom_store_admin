        ...
        <div className="container mx-auto px-4 py-8">
            ...
            {isAdding && (
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
                    <div className="p-5">
                        <h2 className="text-lg font-semibold text-gray-800 mb-4">Create New Brands</h2>
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {brands.length != 0 ?
                                brands.map((brands) => (
                                    <tr key={brands._id || brands.id} className="hover:bg-gray-50">
                                        <td className="px-5 py-4">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-3">
                                                    ...
                                                    <div className="text-xs text-gray-500">/{brands.slug}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-5 py-4 whitespace-nowrap">
                                            <span className={`px-2 py-1 inline-flex text-xs leading-4 font-semibold rounded-full ${brands.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
                                                {brands.isActive ? 'Active' : 'Inactive'}
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-5 py-4 whitespace-nowrap text-sm font-medium">
                                            <div className="flex space-x-2">
                                                ...
                                                <button
                                                    onClick={() => handleDelete(brands._id || brands.id)}
                                ...
                                : <tr ><td colSpan={4} className='py-4 text-center'>No Brands </td></tr>}
